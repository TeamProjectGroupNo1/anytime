...
public class LoginController {
	...
	@GetMapping("generalUserLoginView")
	public String generalUserLoginView() {
		return "login/generalLogin";
	}
	
	@GetMapping(value = "generalUserLogin" , produces = "application/json;charset=utf-8")
	@ResponseBody
	public String generalUserLogin(@RequestBody Map<String, Object> user) {
		System.out.println("id : "+ user.get("id"));
		System.out.println("pwd : "+ user.get("pwd"));
		return "";
	}
